...
# Couldn't edit the prometheus.yml file within Prometheus repo used inside deployment, responsible for adding targets and scrape configs, so had to create own version of prometheus.yml, make modifications, and patch that to the deployment of prometheus
